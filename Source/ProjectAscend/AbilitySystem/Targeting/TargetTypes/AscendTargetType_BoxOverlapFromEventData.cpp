#include "AbilitySystem/Targeting/TargetTypes/AscendTargetType_BoxOverlapFromEventData.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(AscendTargetType_BoxOverlapFromEventData)
...
void FAscendTargetType_BoxOverlapFromEventData::GetTargets(
	...
	TArray<AActor*>& OutActors) const
{
	...
	if (bDrawDebug)
	{
		DrawDebugBox(World, QueryOrigin, HalfExtent, DebugColor.ToFColor(true), false, DebugDuration, 0, DebugThickness);
	}
	...
	FCollisionQueryParams QueryParams(SCENE_QUERY_STAT(AscendTargetTypeBoxOverlap), false, bIgnoreSourceActor ? TargetingActor : nullptr);
