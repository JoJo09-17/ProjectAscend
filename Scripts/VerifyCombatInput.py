...
expected = {
    ...
    'IA_GamepadLightAttack': 'Gamepad_FaceButton_Bottom',
...
for name, key in expected.items():
    matches = [m for m in mappings if m.get_editor_property('action').get_name() == name]
...
unreal.log('COMBAT_INPUT_VERIFIED: 10 persisted mappings')
